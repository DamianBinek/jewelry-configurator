      ...
      <div className="flex sm:hidden">
        <div className="fixed inset-0">
          <div className="canvas-wrap h-full w-full">
            ...
            <div className="pointer-events-auto left-4 md:left-6 top-28 md:top-32 w-full max-w-[300px]">
              <div className="rounded-2xl bg-black/35 backdrop-blur shadow-lg">
                <CatalogPanel />
              </div>
            </div>
            ...
            <div
              className="
      pointer-events-auto  right-4 md:right-6 top-4 md:top-6
      flex flex-col items-end gap-12 md:gap-14 w-full max-w-[300px]
    "
            >
              <div
